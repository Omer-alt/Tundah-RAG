    ...
    st.markdown(
        ...
        <div style="background-color: #7873a5; text-align: center; color: white; margin-left: 40px; width: 100%; position: absolute; top: 50px;">
            ...
            <p style="font-size: 18px; text-align: justify;" >
                Tündah is a web platform dedicated to showcasing how weddings are traditionally organized in Cameroon. Created as an academic project, Tündah was developed by five software engineering students who are passionate about African culture. They recognized the threat of misinformation surrounding customary marriages and decided to use their skills in software development to create this platform. 
            </p>
            <p style="font-size: 18px; text-align: justify;">
                The project aims to combat misinformation by providing accurate and detailed information about Cameroonian wedding traditions. While the focus starts with Cameroon, the team envisions expanding Tündah to cover a broader range of African cultures in the future. Tündah is more than just a school project; it’s a commitment to preserving African heritage and promoting cultural awareness through technology.
            </p>
